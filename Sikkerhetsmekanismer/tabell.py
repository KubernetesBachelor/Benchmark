...
#Funksjon for å regne ut avvik i prosent og lage tabellen
def calculate_percentage_differences(csv_files, file_labels, test_types, identifiers_dict, value_column):
    ...
    for test_type in test_types:
        results = {}
        base_means = {}
        identifiers = identifiers_dict[test_type]
    ...
    # Oppretter en DataFrame fra samlet data
...
identifiers_dict = {
    ...
    'RAM': 'Mode/Threads',  # RAM og Disk har samme identifikator
    'Disk': 'Mode/Threads'
}
